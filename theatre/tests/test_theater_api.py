...
def sample_performance(**params):
    theatre_hall = TheatreHall.objects.create(
        name="Gold Hall", rows=15, seats_in_row=15
    )

    defaults = {
        "show_time": "2025-06-06 16:00:00",
        "play": None,
...
class AuthenticatedPlayApiTests(TestCase):
    ...
    def test_filter_plays_by_actors(self):
        actor1 = Actor.objects.create(first_name="Actor", last_name="1")
        actor2 = Actor.objects.create(first_name="Actor", last_name="2")
    ...
    def test_retrieve_play_detail(self):
        ...
        play.actors.add(Actor.objects.create(first_name="Bob", last_name="Marly"))
...
class AdminMovieApiTests(TestCase):
    ...
    def test_create_play_with_actors(self):
        actor1 = Actor.objects.create(first_name="First", last_name="Actor")
        actor2 = Actor.objects.create(first_name="Second", last_name="Actor")
        payload = {
            "title": "Play",
            "description": "Description",
